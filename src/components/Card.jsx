...
const Card = ({ title, description, imageUrl, link, footer, className, children }) => {
    return (
        <div
            className={`relative group rounded-2xl overflow-hidden shadow-lg bg bg-white dark:bg-gray-800  backdrop-blur-sm transition-all ease-in-out duration-300 hover:scale-105 hover:cursor-pointer ${className}`}
        >
